...
# Delete and recreate the nosql-routes indexing.
#
...
Write-Output '===================='
python search.py delete_indexer nosql-routes
sleep 5

Write-Output '===================='
python search.py delete_index nosql-routes
sleep 5

Write-Output '===================='
python search.py delete_datasource cosmosdb-nosql-dev-routes
sleep 30
